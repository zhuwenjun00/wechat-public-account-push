export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx44ef056cffac89ec",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "b2afe47cc5d9499dc24690b621b45528",
   ...
   */
  USERS: [oGrBI69HYrc-KRvpz0iBguaBW6,oGrBI6ywAB3iG3i4RSf4gvRQCYTs]
    {
      // 想要发送的人的名字
      name: "李玲玉",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "oGrBI69HYrc-KRvpz0iBguaBW66I",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "g9xNzfhR7ofIA3UJepqCC8i9rPwrl1Cq_I-WZBlCUeo",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "广州",
